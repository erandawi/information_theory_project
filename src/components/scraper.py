...
class WebScraper:
    def __init__(self, seed_url, max_pages=10, delay=5, save_dir="data/scraped"):
    ...
    def url_to_filename(self, url):
        ...
        return f"{hash_object.hexdigest()}.html"
    ...
    def crawl(self):
        ...
        while self.to_scrape and self.count < self.max_pages:
            ...
            filename = os.path.join(self.save_dir, self.url_to_filename(url))
